...
## Convención
- Cada prompt es autónomo
- No inventa información
- Usa solo contenido del repositorio
- Cita rutas exactas de archivos

## Carpetas
- ADRs: generación y actualización de decisiones arquitectónicas
- Estudios: síntesis, análisis y exploración
- Presentaciones: creación de decks y workshops
