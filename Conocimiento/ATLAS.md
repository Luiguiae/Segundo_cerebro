...
- [[soberania-epistemica\|Soberanía epistémica]]
  → La soberanía epistémica es la capacidad de un individuo de mantener el control sobre la *estructura* de su propio razon…
- [[sycophancy-como-riesgo-de-diseno\|Sycophancy como riesgo de diseño]]
  → La sycophancy — la tendencia de los modelos de lenguaje a validar lo que el usuario expresa en lugar de responder con p…
...
- [[ingenieria-agentica\|Ingeniería agéntica]]
  → La ingeniería agéntica es el paradigma que sucede al vibe coding. En lugar de escribir código o prompts directamente, e…
...
- [[poblaciones-sinteticas\|Poblaciones sintéticas]]
  → Una población sintética es un conjunto de agentes generados por LLMs que simulan la distribución estadística de comport…
...
- [[workforce-de-agentes\|Workforce de Agentes]]
  → Un *workforce de agentes* es el conjunto de agentes IA que una organización despliega con estructura explícita de emple…
...
- [[diseno-dos-velocidades\|Diseño en dos velocidades]]
  → El trabajo de diseño en la era de la IA se estratifica en dos modos que coexisten y requieren mentalidades completament…
...
- [[marea-creciente-de-automatizacion\|Marea creciente de automatización]]
  → La automatización por IA no ocurre como una ola que golpea súbitamente tareas específicas y deja el resto intacto — ocu…
- [[presupuesto-ia-como-restriccion\|El presupuesto de IA como restricción operativa]]
  → La IA fue adoptada como multiplicador de productividad que se pagaría a sí misma. En 2026 se convirtió en el principal …
...
- [[deuda-cognitiva-organizacional\|Deuda cognitiva organizacional]]
  → Hay una diferencia entre delegar una tarea a una herramienta y delegar el pensamiento que produce esa tarea. La primera…
- [[ia-sin-ecosistema\|IA sin ecosistema]]
  → La IA generativa no falla porque los modelos son insuficientes. Falla porque las organizaciones tratan la tecnología co…
- [[juicio-como-trabajo-completo\|El juicio como trabajo completo]]
  → Cuando los agentes de IA hacen todo el trabajo preparatorio — construyen timelines, analizan casos, redactan resúmenes,…
...
- [[corrupcion-silenciosa-por-delegacion\|Corrupción silenciosa por delegación]]
  → Cuando un LLM edita documentos de forma continua en nombre del usuario, introduce errores dispersos pero severos que se…
...
### `requires`
- [[automatizar-mi-propio-trabajo]] → [[expertise-de-dominio-en-producto]]
- [[capital-de-contexto]] → [[espectro-autonomia-agente]]
- [[capital-de-contexto]] → [[fabrica-oscura-de-software]]
- [[confianza-a-traves-de-velocidad]] → [[pit-stop-cognitivo]]
- [[disenador-a-constructor]] → [[ia-como-filtro-de-entrada]]
- [[espectro-autonomia-agente]] → [[capital-de-contexto]]
- [[expertise-de-dominio-en-producto]] → [[automatizar-mi-propio-trabajo]]
- [[feedback-que-escala]] → [[pit-stop-cognitivo]]
...
- [[fabrica-oscura-de-software]] → [[espectro-autonomia-agente]]

### `same_mechanism_as`
- [[automatizacion-vs-ampliacion]] → [[fundamentales-vs-flux]]
- [[fundamentales-vs-flux]] → [[automatizacion-vs-ampliacion]]
- [[gobernanza-ia-performativa]] → [[senal-anticipada-mercado-laboral]]
- [[senal-anticipada-mercado-laboral]] → [[gobernanza-ia-performativa]]
