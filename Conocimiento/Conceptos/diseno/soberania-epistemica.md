...
- **67.3%**: porcentaje de investigación AI-HCI orientada a usabilidad sin fricción en 2026 — hegemonía estructural del campo — arXiv 2603.21735.
- **1,223 papers** analizados como base empírica del estudio de tendencias AI-HCI (2023–2026) — arXiv 2603.21735.
- **27%** más problemas de usabilidad omitidos cuando se revisan outputs AI versus trabajo independiente — Springer/AI&Society, 2025.
...
- **17% menos comprensión del código** en colaboradores con asistencia IA continua vs. quienes pausaban periódicamente — Anthropic RCT, arXiv 2604.13277 (dato paralelo del vault, confirma el mismo mecanismo en ingeniería).
- **EU AI Act (2025)**: obliga a proveedores de IA a diseñar sistemas que permitan a los supervisores humanos ser conscientes de su propia tendencia al sesgo de automatización — validación regulatoria del principio como requisito de diseño, arXiv 2502.10036.
...
**El límite de escala con supervisión paralela**: a medida que los agentes manejan más decisiones en paralelo, mantener soberanía epistémica sobre cada output se vuelve estructuralmente imposible sin un sistema de pre-compromiso atencional. El diseño de fricción epistémica requiere jerarquizar: ¿sobre qué decisiones es irrenunciable la soberanía?

## Ejes investigados

**Eje 1 — El mecanismo cognitivo: cómo la fluidez sin fricción explota el Sistema 1**
Búsquedas en arXiv cs.HC sobre cognitive miserliness, automation bias y dual-process theory en AI interfaces. Hallazgos: arXiv 2603.21735 formaliza el mecanismo describiendo cómo las interfaces IA de fricción cero alimentan directamente el Sistema 1 sin activar el Sistema 2, produciendo cierre cognitivo prematuro. El mecanismo es estructural: no depende de la irracionalidad del usuario, sino de la arquitectura de la interfaz. Fuentes sólidas encontradas: 2.

**Eje 2 — La evidencia empírica: el costo medible del diseño sin fricción epistémica**
Búsquedas en HCI, educación y regulación sobre automation bias, desirable difficulties en LLMs y estudios de supervisión humana de outputs IA. Hallazgos: convergencia de tres ámbitos independientes (HCI, educación, regulación de la UE) apunta al mismo efecto — la fluidez sin fricción degrada la calidad del juicio humano de forma cuantificable. El dato educativo (48% rendimiento / 17% comprensión) es el análogo más claro del mecanismo en un entorno controlado. Fuentes sólidas encontradas: 3.

**Eje 3 — Las implicaciones de diseño: fricción epistémica como función, no como error**
Búsquedas sobre cognitive forcing functions, scaffolded friction frameworks y UX design para autonomía cognitiva. Hallazgos: el paper 2603.21735 propone restructurar sistemas IA como "funciones de forzado cognitivo" (*cognitive forcing functions*) en lugar de oráculos convergentes, con siete marcos basados en evidencia. El mecanismo central: negar deliberadamente al usuario un consenso listo impone la adjudicación lógica final en el operador humano. Conexión directa con `ux-checkpoints` del vault: el checkpoint es la implementación de diseño de la fricción epistémica. Fuentes sólidas encontradas: 2.
